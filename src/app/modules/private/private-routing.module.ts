...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../../pages/create-session/create-session.module').then(
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../../pages/created-by-me/created-by-me.module').then(
            (m) => m.CreatedByMePageModule
          ),
        canActivate: [PrivateGuard],
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../../pages/home-search/home-search.module').then(
            (m) => m.HomeSearchPageModule
          ),
        canActivate: [PrivateGuard],
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../../pages/help-video/help-video.module').then(
            (m) => m.HelpVideoPageModule
          ),
        canActivate: [PrivateGuard, AllowPageAccess],
        data: {
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            '../../pages/mentor-questionnaire/mentor-questionnaire.module'
          ).then((m) => m.MentorQuestionnairePageModule),
        canActivate: [PrivateGuard],
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../../pages/login-activity/login-activity.module').then(
            (m) => m.LoginActivityPageModule
          ),
        canActivate: [PrivateGuard, AllowPageAccess],
        data: {
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            '../../pages/mentor-search-directory/mentor-search-directory.module'
      ...
      {
        path: CommonRoutes.SESSION_REQUEST_DETAILS,
        loadChildren: () =>
          import('../../pages/session-request-details/session-request-details.module').then(
            (m) => m.SessionRequestDetailsPageModule
          ),
        canActivate: [PrivateGuard],
      },
      {
